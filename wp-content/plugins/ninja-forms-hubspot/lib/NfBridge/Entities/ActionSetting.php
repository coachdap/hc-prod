...
use NFHubspot\EmailCRM\Shared\Contracts\FormActionField;
use NFHubspot\EmailCRM\NfBridge\Entities\Options;
...
class ActionSetting extends SimpleEntity implements FormActionField
{
	 ...
	 * @return ActionSetting
	 */
	public function setUseMergeTags($value): ActionSetting
	{
