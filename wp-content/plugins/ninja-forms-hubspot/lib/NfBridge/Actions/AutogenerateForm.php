...
class AutogenerateForm
{
	...
	protected function addSubmitButton(): void
	{
		...
		$settings = array(
			'type' => 'submit',
			'label' => __('Submit','ninja-forms-hubspot'),
			'label_post' => 'inside',
			'key' => 'submit'
		);
		$nfField->update_settings($settings)->save();
	...
	protected function addSaveAction()
	{
		...
		$actionMeta = [
			'type' => 'save',
			'label' => __('Store Submission','ninja-forms-hubspot'),
			'active' => '1'
		];
	...
	protected function addSuccessMessageAction()
	{
		...
		$actionMeta = [
			'type' => 'successmessage',
			'label' => __('Success Message','ninja-forms-hubspot'),
			'success_msg' => '<p>'.__('Your form has been successfully submitted.','ninja-forms-hubspot').'</p><p><br></p>',
			'active' => '1'
		];
