...
function amp_ninja_field_markup($s){
	...
	$fieldHtml = amp_ninja_template_cleanup($s, $fieldHtml, $fieldTypeName);
	if(isset($s['options'])){
...
function amp_ninja_template_cleanup($s, $fieldHtml, $fieldTypeName = ''){
...
function amp_ninja_wrapper_template_cleanup($fieldWrapper, $fieldLabel,$fieldsHtml,$field){
