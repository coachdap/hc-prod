...
class AMP_NF_AJAX_Controllers_Submission extends AMP_NF_Abstracts_Controller
{
    ...
    protected function process()
    {
        ...
        */
        ...
        foreach( $form_fields as $key => $field ){
            ...
            if(is_array($this->_form_data[ 'fields' ][ $field_id ])){
        ...
        */
         ...
         */
        if(is_array($this->_data[ 'extra' ] || $this->_form_data[ 'extra' ] )){
...
//validation function
    protected function ampforwp_validate_check( $field_settings, $form_data ){
    ...
    { 
        ...
        //print_r($field_class);
        if( $errors = $this->ampforwp_validate_check( $field_settings, $this->_form_data ) ){
