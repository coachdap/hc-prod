	...
	private function add_top_bar_options() {
		...
		$this->add_control(
			new Hestia_Customizer_Control(
				...
				array(
					...
					'text_before'     => '<span class="dashicons dashicons-info" style="margin-right: 3px"></span>' . __( 'Customize the Very Top Bar Menu', 'hestia-pro' ),
					'text_after'      => '.',
					'button_text'     => __( 'here', 'hestia-pro' ),
					'is_button'       => false,
					'focus_type'      => 'section',
		...
		$this->add_control(
			new Hestia_Customizer_Control(
				...
				array(
					'container_class' => 'quick-links',
					'text_before'     => '<span class="dashicons dashicons-info" style="margin-right: 3px"></span>' . __( 'Edit the Very Top Bar Widgets', 'hestia-pro' ),
					'text_after'      => '.',
					'button_text'     => __( 'here', 'hestia-pro' ),
					'is_button'       => false,
					'focus_type'      => 'section',
	...
	private function add_navigation_options() {
		...
		$this->add_control(
			new Hestia_Customizer_Control(
				...
				array(
					'container_class' => 'quick-links',
					'text_before'     => '<span class="dashicons dashicons-info" style="margin-right: 3px"></span>' . __( 'Edit the Navigation Widgets', 'hestia-pro' ),
					'text_after'      => '.',
					'button_text'     => __( 'here', 'hestia-pro' ),
					'is_button'       => false,
					'focus_type'      => 'section',
